...
# Netflix Stock Close Prices Over Time 
...
# Netflix Stock Prices Over Time
...
# Netflix Stock Trading Volume Over Time
library(ggplot2)
library(scales)
...
# Opening prices by month for the year 2024
